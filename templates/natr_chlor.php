<div id="pageBarit" class="container-fluid">
	<div class="row">
		<div  class="col-sm-4">
			<div id="circle_1">
		...
		<div id="product_desc" class="col-sm-4">
			<p id="head">Натрий хлористый</p>
			<p id="prod_Text">
			Представляет собой белый кристаллический продукт плотностью 2170 кг/м<sup>3</sup>. Нейтральный электролит, мало меняющий щелочность среды. Концентрация от 30 до 360 кг/м<sup>3</sup>. Как структурообразователь перестабилизированных пресных растворов 0,1-0,3% от объема раствора. Как ингибитор глин до 5%.</p>
			<p id="prod_Text">
			Натрий хлористый применяется:</p>
			<ul class="prod_Text">
				<li class="prod_Text">для повышения структурно-механических свойств БР, обработанных защитными коллоидами (УЩР);</li>
				<li class="prod_Text">для повышения СНС при бурении на карбонатно-глинистых суспензиях;</li>
				<li class="prod_Text">при проходке пластов каменной соли;</li>
				<li class="prod_Text">регулятора осмотической активности водной фазы гидрофобно-эмульсионных растворов.</li>
			</ul>
			<p id="prod_Text">Физико-химические показатели:</p>
			<table id="prod_Table">
				<tr class="inside_Table">
					<th class="inside_Table">Наименование показателя</th>
					<th class="inside_Table">Технические характеристики</th>
				</tr>
				<tr class="inside_Table">
					<td class="inside_Table">Внешний вид</td>
					<td class="inside_Table">Бесцветные кристаллы со светло-серым оттенком</td>
				</tr>
				<tr class="inside_Table">
					<td class="inside_Table">Помол</td>
					<td class="inside_Table">№2</td>
				</tr>
				<tr class="inside_Table">
					<td class="inside_Table">Содержание NaCI, %</td>
					<td class="inside_Table">98,07</td>
				</tr>
				<tr class="inside_Table">
					<td class="inside_Table">Нерастворимый остаток, %</td>
					<td class="inside_Table">0,19</td>
				</tr>
				<tr class="inside_Table">
					<td class="inside_Table">Содержание влаги, %</td>
					<td class="inside_Table">2,03</td>
				</tr>
				<tr class="inside_Table">
					<td class="inside_Table">Плотность, г/см<sup>3</sup></td>
					<td class="inside_Table">2,17</td>
				</tr>
			</table>
			<p id="prod_Text">
			Преимуществом натрия хлористого по сравнению с другими солями является незначительное повышение концентрации насыщения при увеличении температуры до 100<sup>o</sup>С.</p>
			<img src="images/truck_gr.png" alt="truck" style="width:15%; height:10%; margin-right:3%; margin-top: 1%; margin-bottom: 1%; float:left; " >
			<p id="prod_Text">Поставка продукции потребителю производится ж/д и авто транспортом.</p>
			<p id="prod_Text">Хлористый натрий фасуется в полипропиленовые мешки по 25 кг (либо 35 кг).</p>
		</div>
	</div>
