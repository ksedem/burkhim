<div id="pageBarit" class="container-fluid">
	<div class="row">
		...
		<div id="product_desc" class="col-sm-4">
			<p id="head">Графит</p>
			<p id="prod_Text">
			Графит представляет собой темно-серый кристаллический порошок, имеющий слабый металлический блеск. Химический состав порошка зависит от метода его производства, а также от степени чистоты исходных материалов. В зависимости от технологии флюс может использоваться в виде жидкости, пасты или порошка.</p>
			<p id="prod_Text">
			Рекомендуется к применению на газовых месторождениях как противоприхватная добавка к буровому раствору при подготовке  ствола к спуску обсадных колонн.</p>
			<p id="prod_Text">Физико-химические показатели:</p>
			<table id="prod_Table">
				<tr class="inside_Table">
					<th class="inside_Table">Наименование показателя</th>
					<th class="inside_Table">Значение, %</th>
				</tr>
				<tr class="inside_Table">
					<td class="inside_Table">Массовая доля углерода</td>
					<td class="inside_Table">97,0-97,5</td>
				</tr>
				<tr class="inside_Table">
					<td class="inside_Table">Массовая доля серы</td>
					<td class="inside_Table">0,13-0,3</td>
				</tr>
				<tr class="inside_Table">
					<td class="inside_Table">Массовая доля влаги</td>
					<td class="inside_Table">Не более 1,0</td>
				</tr>
				<tr class="inside_Table">
					<td class="inside_Table">Массовая доля золы</td>
					<td class="inside_Table">2,2-2,6</td>
				</tr>
				<tr class="inside_Table">
					<td class="inside_Table">Массовая доля фосфора</td>
					<td class="inside_Table">0,004</td>
				</tr>
			</table>
			...
			<p id="prod_Text">Графит расфасовывается в полипропиленовые и бумажные мешки весом 20-30 кг.</p>
		</div>
	</div>
